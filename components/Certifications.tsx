                ...
                <div className="flex flex-col justify-center p-2">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full bg-purple/10 flex items-center justify-center">
                      <FaAward className="text-purple" size={20} />
                    </div>
                    <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-purple">
                      {cert.title}
                    </h3>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      <span className="text-white-100/60 w-24">Issued:</span>
